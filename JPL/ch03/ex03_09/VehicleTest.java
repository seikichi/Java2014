...
public class VehicleTest {
  ...
  public void cloneIsCorrectlyImplemented() {
    ...
    assertThat(cloned.getSpeed(), is(vehicle.getSpeed()));
    assertThat(cloned.getAngle(), is(vehicle.getAngle()));
    assertThat(cloned.getOwnerName(), is(vehicle.getOwnerName()));
    assertThat(cloned.getID(), is(not(vehicle.getID())));
  }
